...
Constant variance and normal distribution assumptions are quite well satisfied
...
p_lm_out <- plot(ggpredict(err.lm2.L, terms = "MeanJerk1 [X_mj]")) +
  ylim(0, 0.65) +
  labs(x = "Mean jerk (m/s^3)", y = "Errors per sec.") +
  ggtitle("Errors per sec. - fitted Gaussian model with 95 % prediction interval") + 
  theme_classic()
